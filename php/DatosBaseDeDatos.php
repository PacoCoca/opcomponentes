...
$query15="INSERT INTO Catalogo_tiene(idCatalogo,idProducto,precio,descripcion,nombre) VALUES ('1', '1', '150', 'es una tarjeta grafica', 'tarjeta grafica');";
$rs15 = mysqli_query($conn,$query15);

$query16="INSERT INTO Catalogo_tiene(idCatalogo,idProducto,precio,descripcion,nombre) VALUES ('2', '3', '50', 'es un procesador para un servido', 'procesador servidor');";
